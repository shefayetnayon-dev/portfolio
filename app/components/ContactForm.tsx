...
const ContactForm = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setSubmitMessage('Message sent successfully. Check your inbox for confirmation.');
      setFormData({
        name: '',
        email: '',
        subject: '',
      ...
      setSubmitMessage('Error: Failed to send message. Please retry.');
      ...
      <div className="max-w-5xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="bg-[#161b22] rounded-lg border border-gray-700 shadow-2xl overflow-hidden"
          >
            ...
            <div className="p-6">
              {submitStatus === 'success' ? (
                <div className="text-green-400 space-y-2">
                  <p className="flex items-center"><span className="mr-2">➜</span> Connecting to server...</p>
                  <p className="flex items-center"><span className="mr-2">➜</span> Sending data packets...</p>
                  <p className="flex items-center"><span className="mr-2">➜</span> <FiCheckCircle className="mr-2" /> {submitMessage}</p>
                  <button
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-transparent border-b border-gray-700 focus:border-green-500 text-gray-300 py-1 px-2 focus:outline-none transition-colors"
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      onChange={handleChange}
                      rows={4}
                      className="w-full bg-[#0d1117] border border-gray-700 focus:border-green-500 text-gray-300 p-2 rounded focus:outline-none transition-colors"
                  ...
                  <button
                    ...
                    className="w-full py-2 bg-green-600/20 text-green-500 border border-green-500/50 hover:bg-green-600/30 transition-all rounded mt-4 flex items-center justify-center space-x-2"
                  >
                    {isSubmitting ? (
            ...
            <div className="bg-[#161b22] p-6 rounded-lg border border-gray-700">
              ...
              <div className="space-y-4 font-mono text-sm">
                <div className="flex">
                  ...
                  <span className="text-green-400">"shefayetnayon@gmail.com"</span>,
                </div>
                <div className="flex">
              ...
              <div className="flex flex-wrap gap-4">
                {[
                  ...
                  <a
                    ...
                    className="p-3 bg-[#0d1117] border border-gray-700 rounded hover:border-green-500 hover:text-green-400 transition-all group"
