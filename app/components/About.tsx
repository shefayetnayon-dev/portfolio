  ...
  return (
    <section className="py-20 bg-[#0d1117] text-gray-300 font-mono" id='about'>
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto border border-gray-700 rounded-lg bg-[#0d1117] overflow-hidden shadow-xl">
          {/* Window Header */}
          ...
          <div className="flex flex-col md:flex-row">
            ...
            <div className="hidden md:block w-64 border-r border-gray-700 bg-[#0d1117] p-4">
              ...
              <ul className="space-y-2 text-sm ml-4 border-l border-gray-700 pl-4">
                ...
                <li className="flex items-center space-x-2 text-gray-500 hover:text-gray-300 cursor-pointer p-1">
                  <FiCode />
              ...
              >
                ...
                <div className="flex flex-wrap gap-2 mb-8">
                  {skills.map((skill, index) => (
                    <span key={index} className="px-3 py-1 bg-blue-900/20 text-blue-400 border border-blue-500/30 rounded text-sm">
                      {skill}
                    </span>
                  ))}
                </div>
                ...
                <div className="mt-8 pt-6 border-t border-gray-700">
                  ...
                  <div className="mt-2 flex gap-1">
                    {contributionData.length > 0 ? (
                      ...
                      // Skeleton or default state for SSR
                      [...Array(30)].map((_, i) => (
                        <div
                          key={i}
